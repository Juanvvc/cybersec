...
1. Identification—monitor IT systems and detect deviations from normal operations, and see if they represent actual security incidents. When an incident is discovered, collect additional evidence, establish its type and severity, and document everything.
...
![center w:20em](https://d2slcw3kip6qmk.cloudfront.net/marketing/pages/chart/examples/officenetworkdiagram.png)

## Identify threats, assets and vulnerabilities

![w:20em center](https://threatsketch-wpengine.netdna-ssl.com/wp-content/uploads/2016/05/File_000-2.jpeg)
...
![bg left:40% width:100%](https://mk0resourcesinf5fwsf.kinstacdn.com/wp-content/uploads/112113_1458_WindowsSyst5.png)
...
# SOCVEL Blue Team Training CFT
<!-- _class: lead -->

## Losprys
<!-- _class: center -->

![center](https://socvel.com/images/socvel.png)
...
![ center w:15em](https://raw.githubusercontent.com/countercept/chainsaw/master/chainsaw.png)
